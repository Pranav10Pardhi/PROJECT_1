...
def generate_qr_code():
    ...
    website_url = "https://college-navigation-gghyxenvfpypy5jgzxm8hj.streamlit.app/"  # Replace with your actual website
...
# ... existing code ...
    ...
    if st.sidebar.button("Generate QR Code"):
        ...
        st.sidebar.markdown("[Visit Website](https://college-navigation-gghyxenvfpypy5jgzxm8hj.streamlit.app/)")  # Replace URL here too
